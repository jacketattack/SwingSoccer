  ...
  constructor(scene, x, y, fontColor, button_image, text, callback) {
    ...
    button.on("pointerover", function () {
      ...
      button.setDisplaySize(
        button.width * size_factor,
        button.height * size_factor
      );
      buttonText.setDisplaySize(
        buttonText.width * size_factor,
        buttonText.height * size_factor
      );
    });
